...
# extend features: 11 degree polynomial
pf11 = PolynomialFeatures(degree=11)
Xpoly = pf11.fit_transform(X)
...
plt.savefig('polyreg11.png', dpi=300)
plt.show()
